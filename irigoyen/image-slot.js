...
(() => {
  ...
  // utm_source identifica al sitio que envía el tráfico de vuelta a
  // Unsplash, como pide su guía de atribución.
  const UNSPLASH_HOMEPAGE_HREF =
    'https://unsplash.com/?utm_source=juancornejo&utm_medium=referral';
  ...
  const withReferral = (href) => {
    try {
      ...
      if (!u.searchParams.has('utm_source')) {
        u.searchParams.set('utm_source', 'juancornejo');
      }
  ...
  class ImageSlot extends HTMLElement {
    ...
    _render() {
      ...
      // (lo escribe el autor en el HTML) so it passes through unchanged.
